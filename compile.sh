...
rm /workspaces/ICS3U-Final-Project-GBDK-Kenny-Le-281/simulator/rom/game.gb

# compile to game
/opt/gbdk/bin/lcc -Wa-l -Wl-m -Wl-j -o $base_name.gb $base_name.c

# move it to the simulator directory
cp ./$base_name.gb /workspaces/ICS3U-Final-Project-GBDK-Kenny-Le-281/simulator/rom/game.gb
